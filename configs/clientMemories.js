...
//];
var MY_MEMORY = !window || !window.location || !window.location.protocol || !window.location.host ? "https://dev-pl-redhat.193b.starter-ca-central-1.openshiftapps.com/gun" : window.location.protocol + "//" + window.location.host + "/gun";
